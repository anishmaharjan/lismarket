             ...
             <View style = {styles.itemContainer}>
                      ...
                      <View style={{flex: 1, flexDirection :'row', justifyContent: 'center', paddingTop: 1 }}>
                          ...
                          <View style={{flex: 1, alignItems: 'flex-start', justifyContent: 'space-around', flexDirection:'row', paddingTop: 10 }}>
                            <TouchableOpacity><Icon name="cube" size={26} color="#74D4DE" /></TouchableOpacity>
                            <TouchableOpacity><Icon name="mouse" size={26} color="#74D4DE" /></TouchableOpacity>
                              <TouchableOpacity><Icon name="dog" size={26} color="#74D4DE" /></TouchableOpacity>
                          </View>
                       </View>
               </View>
      </View>
